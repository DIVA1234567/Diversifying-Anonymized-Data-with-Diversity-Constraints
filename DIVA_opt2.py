...
MAX_DEPENDENCY_GEN_CGU_THRESHOLD = 1.0 
...
def generate_min_preserve_clustering(dataset_name, dataset_info, k_size):
     ...
     while True: 
          ...
          for class_i in list(classes_distance.keys()): 
               ...
               while True: 
                    ...
                    # Check if the threshold has reached for the class 
                    if _class_cntr >= len(class_distance_i[CLASSES_DISTANCE_INFO_IDX]):
                    ...
                    try: 
                         ...
                         # Increment the class counter as the combination is successfully generated
                         _class_cntr += 1 
...
if __name__ == '__main__':
     ...
     if 3 == len(sys.argv):
          ...
          clustering_info, pattern_info, qid_info = generate_min_preserve_clustering(dataset_name, dataset_info, k_size)
          ...
          # print("Usage:")
          print("python <program_name.py> <dataset_name> <k-anonymity_size>")
          pass
